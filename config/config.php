...
return [
	'stable' => [
		'20' => [
			'100' => [
				'latest' => '20.0.5',
				'internalVersion' => '20.0.5.2',
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-20.0.5.zip',
				'web' => 'https://docs.nextcloud.com/server/20/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '7.2',
				'signature' => 'ZRpAEW/9+vYtb6GGyHdkG7Kvjla6ncXip+CJ5YBfkSYHQ6+Pfmm4/EVM4cPnqttN
...
+Hy3LiZGWSIEYhjEt7+UUw==',
		...
		'19' => [
			'100' => [
				'latest' => '19.0.7',
				'internalVersion' => '19.0.7.1',
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-19.0.7.zip',
				'web' => 'https://docs.nextcloud.com/server/19/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '7.2',
				'signature' => '',
			],
		],
		'18.0.13' => [
			'100' => [
...
NCG81lx4T14ignMP4o0uEw==',
		...
		'18' => [
			'100' => [
				'latest' => '18.0.13',
				'internalVersion' => '18.0.13.1',
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-18.0.13.zip',
				'web' => 'https://docs.nextcloud.com/server/18/admin_manual/maintenance/upgrade.html',
				'eol' => true,
				'minPHPVersion' => '7.2',
				'signature' => '',
			],
		],
		'17.0.10' => [
			'100' => [
...
N5YeYC8UmQMMnfMK8Z4xIg==',
		...
		'20' => [
			'100' => [
				'latest' => '20.0.6 RC1',
				'internalVersion' => '20.0.6.0',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-20.0.6RC1.zip',
				'web' => 'https://docs.nextcloud.com/server/20/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '7.2',
				'signature' => '',
			],
		],
		'19.0.7' => [
            '100' => [
...
HmY13Wyk9b8JpDfDsgdjhA==',
		...
		'19' => [
			'100' => [
				'latest' => '19.0.8 RC1',
				'internalVersion' => '19.0.8.0',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-19.0.8RC1.zip',
				'web' => 'https://docs.nextcloud.com/server/19/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '7.2',
				'signature' => '',
			],
		],
		'18.0.14' => [
            '100' => [
...
gjfXFODgrvEKse0ffCzVjA==',
        ...
        '18' => [
            '100' => [
                ...
                'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-18.0.14RC1.zip',
                'web' => 'https://docs.nextcloud.com/server/18/admin_manual/maintenance/upgrade.html',
                'eol' => true,
                'minPHPVersion' => '7.2',
                'signature' => '',
            ],
        ],
		'17' => [
            '100' => [
