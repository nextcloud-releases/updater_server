	...
	'stable' => [
		'24' => [
			'100' => [
				...
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-24.0.4.zip',
				'web' => 'https://docs.nextcloud.com/server/24/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '7.4',
				'signature' => '
...
75b1kw9sirSo1svalGz1Gg==',
		...
		'23' => [
			'100' => [
				'latest' => '23.0.8',
				'internalVersion' => '23.0.8.1',
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-23.0.8.zip',
				'web' => 'https://docs.nextcloud.com/server/23/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '7.3',
				'signature' => 'uW+L/ntKG9gTGOlHLdhok5DZx+w3KTqU+PFRAfkUACS//qU57VQ8XSm1Gki6qqg8
...
ZH1PxQilL7ihAvnOb2oU1Q==',
	...
	'beta' => [
		'25' => [
			'100' => [
				'latest' => '25.0.0 beta 3',
				'internalVersion' => '25.0.0.7',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-25.0.0beta3.zip',
				'web' => 'https://docs.nextcloud.com/server/25/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '7.4',
				'signature' => '',
			],
		],
		'24.0.5' => [
			'100' => [
...
U+iEa4Dm8DrdnqUycYlfGQ==',
		...
		'24' => [
			'100' => [
				'latest' => '24.0.5 RC1',
				'internalVersion' => '24.0.5.0',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-24.0.5rc1.zip',
				'web' => 'https://docs.nextcloud.com/server/24/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '7.4',
				'signature' => '',
			],
		],
		'23.0.9' => [
			'100' => [
...
hIp3jPPV18lOTwZpfAB9yA==',
		...
		'23' => [
			'100' => [
				'latest' => '23.0.9 RC1',
				'internalVersion' => '23.0.9.0',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-23.0.9rc1.zip',
				'web' => 'https://docs.nextcloud.com/server/23/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '7.3',
				'signature' => '',
			],
		],
