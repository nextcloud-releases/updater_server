...
return [
	'stable' => [
		'31' => [
			'100' => [
				'latest' => '31.0.5',
				'internalVersion' => '31.0.5.1',
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-31.0.5.zip',
...
4CPP2tsMCaJcvl5Jh1tmog==',
		...
		'30' => [
			'100' => [
				'latest' => '30.0.11',
				'internalVersion' => '30.0.11.1',
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-30.0.11.zip',
				'web' => 'https://docs.nextcloud.com/server/30/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.1',
				'signature' => '',
			],
		],
		'29.0.16.1' => [
			'100' => [
...
vbaIJ8CiZnKdMBDAdXAVMA==',
	...
	'beta' => [
		'31' => [
			'100' => [
				'latest' => '31.0.6 RC1',
				'internalVersion' => '31.0.6.0',
				'downloadUrl' => 'https://github.com/nextcloud-releases/server/releases/download/v31.0.6rc1/nextcloud-31.0.6rc1.zip',
				'web' => 'https://docs.nextcloud.com/server/31/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.1',
				'signature' => '',
			],
		],
		'30.0.12.0' => [
			'100' => [
...
polJal2SrG/OFzIf6dy6xw==',
		...
		'30' => [
			'100' => [
				'latest' => '30.0.12 RC1',
				'internalVersion' => '30.0.12.0',
				'downloadUrl' => 'https://github.com/nextcloud-releases/server/releases/download/v30.0.12rc1/nextcloud-30.0.12rc1.zip',
				'web' => 'https://docs.nextcloud.com/server/30/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.1',
				'signature' => '',
			],
		],
		'29.0.16.1' => [
			'100' => [
