...
S43iWfUbYsoYueTboeC29A==',
		...
		'23' => [
			'100' => [
				'latest' => '23.0.5',
				'internalVersion' => '23.0.5.1',
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-23.0.5.zip',
				'web' => 'https://docs.nextcloud.com/server/23/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '7.3',
				'signature' => 'yQu5YFT0hxFKeSH2dJm+U5aTiGRGe10OFjR7bwjRB8y9bKwU0AJUCNisutDAT8IU
...
AcBLHwFr2QvDXmEz9hpEiw==',
		...
		'22' => [
			'100' => [
				'latest' => '22.2.8',
				'internalVersion' => '22.2.8.1',
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-22.2.8.zip',
				'web' => 'https://docs.nextcloud.com/server/22/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '7.3',
				'signature' => '
...
ZH1PxQilL7ihAvnOb2oU1Q==',
	...
	'beta' => [
		'24' => [
			'100' => [
				'latest' => '24.0.2 RC1',
				'internalVersion' => '24.0.2.0',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-24.0.2rc1.zip',
				'web' => 'https://docs.nextcloud.com/server/24/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '7.4',
				'signature' => '',
			],
		],
		'23.0.6' => [
			'100' => [
...
8tSY8vRS9BhFQooAcIRTWQ==',
		...
		'23' => [
			'100' => [
				'latest' => '23.0.6 RC1',
				'internalVersion' => '23.0.6.0',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-23.0.6rc1.zip',
				'web' => 'https://docs.nextcloud.com/server/23/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '7.3',
				'signature' => '',
			],
		],
...
NaSWSF26bQacrUefNluuFg==',
		...
		'22' => [
			'100' => [
				'latest' => '22.2.9 RC1',
				'internalVersion' => '22.2.9.0',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-22.2.9rc1.zip',
				'web' => 'https://docs.nextcloud.com/server/22/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '7.3',
				'signature' => '',
			],
		],
