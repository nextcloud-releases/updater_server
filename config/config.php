...
return [
	'production' => [
		'12' => [
			'100' => [
				'latest' => '12.0.2',
				'internalVersion' => '12.0.2.0',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-12.0.2.zip',
...
tJejM2uk8UEjo4mJ6q7BIA==',
	...
	'beta' => [
		'12' => [
			'100' => [
				'latest' => '12.0.3 RC1',
				'internalVersion' => '12.0.3.0',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-12.0.3RC1.zip',
				'web' => 'https://docs.nextcloud.com/server/12/admin_manual/maintenance/upgrade.html',
				'minPHPVersion' => '5.6',
				'signature' => '',
			],
		],
		'11' => [
			'100' => [
