...
return [
	'stable' => [
		'28' => [
			'100' => [
				'latest' => '28.0.2',
				'internalVersion' => '28.0.2.5',
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-28.0.2.zip',
				'web' => 'https://docs.nextcloud.com/server/28/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.0',
				'signature' => '',
			],
		],
		'27.1.6' => [
			'100' => [
...
FkLkH18pVbUk7ejHRNhUDg==',
		...
		'27' => [
			'100' => [
				'latest' => '27.1.6',
				'internalVersion' => '27.1.6.2',
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-27.1.6.zip',
				'web' => 'https://docs.nextcloud.com/server/27/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.0',
				'signature' => '',
			],
		],
		'26.0.11' => [
			'100' => [
...
hcSHq8uqY5K6K+vELwAsGw==',
		...
		'26' => [
			'100' => [
				'latest' => '26.0.11',
				'internalVersion' => '26.0.11.2',
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-26.0.11.zip',
				'web' => 'https://docs.nextcloud.com/server/26/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.0',
				'signature' => '',
			],
		],
		'25.0.13' => [
			'100' => [
...
ZH1PxQilL7ihAvnOb2oU1Q==',
	...
	'beta' => [
		'28' => [
			'100' => [
				'latest' => '28.0.3 RC2',
				'internalVersion' => '28.0.3.1',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-28.0.3rc2.zip',
				'web' => 'https://docs.nextcloud.com/server/28/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.0',
				'signature' => '',
	],
		],
		'27.1.7' => [
			'100' => [
...
hElr4EbxnhiZhI3xngVzyw==',
		...
		'27' => [
			'100' => [
				'latest' => '27.1.7 RC1',
				'internalVersion' => '27.1.7.0',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-27.1.7rc1.zip',
				'web' => 'https://docs.nextcloud.com/server/27/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.0',
				'signature' => '',
			],
		],
		'26.0.12' => [
			'100' => [
...
N4RVcdPxBgEeZqsC1Y2Hjw==',
		...
		'26' => [
			'100' => [
				'latest' => '26.0.12 RC1',
				'internalVersion' => '26.0.12.0',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-26.0.12rc1.zip',
				'web' => 'https://docs.nextcloud.com/server/26/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.0',
				'signature' => '',
			],
		],
		'25.0.13' => [
			'100' => [
