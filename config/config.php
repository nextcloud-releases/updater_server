...
return [
	'stable' => [
		'30' => [
			'100' => [
				'latest' => '30.0.3',
				'internalVersion' => '30.0.3.2',
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-30.0.3.zip',
				'web' => 'https://docs.nextcloud.com/server/30/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.1',
				'signature' => '',
			],
		],
		'29.0.8.1' => [
			'100' => [
...
nuJnyU9/LSVwAkOxoKZTOg==',
		...
		'28' => [
			'100' => [
				...
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-28.0.12.zip',
				'web' => 'https://docs.nextcloud.com/server/28/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.0',
				'signature' => '',
			],
		],
		'27.1.11.3' => [
			'100' => [
...
cHb9IfSj/n95p6H7H/GyXw==',
		...
		'29' => [
			'100' => [
				'latest' => '29.0.10 RC1',
				'internalVersion' => '29.0.10.0',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-29.0.10rc1.zip',
				'web' => 'https://docs.nextcloud.com/server/29/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.0',
				'signature' => '',
			],
		],
		'28.0.13.0' => [
			'100' => [
