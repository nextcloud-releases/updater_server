	...
	'stable' => [
		29 => [
			100 => [
				...
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-29.0.1.zip',
...
QnK0Bov0chs7kRKuaA/Hew==',
		...
		27 => [
			100 => [
				'latest' => '27.1.10 RC2',
				'internalVersion' => '27.1.10.1',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-27.1.10rc2.zip',
				'web' => 'https://docs.nextcloud.com/server/27/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.0',
				'signature' => '',
			],
		],
		'26.0.13.1' => [
			100 => [
