...
return [
	'stable' => [
		'31' => [
			'100' => [
				'latest' => '31.0.3',
				'internalVersion' => '31.0.3.2',
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-31.0.3.zip',
				'web' => 'https://docs.nextcloud.com/server/31/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.1',
				'signature' => '',
			],
		],
		'30.0.9.2' => [
			'100' => [
...
VnlpNk7RSuYdsBckwo1QmQ==',
		...
		'30' => [
			'100' => [
				'latest' => '30.0.9',
				'internalVersion' => '30.0.9.2',
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-30.0.9.zip',
...
',
			],
		],
		'29.0.15.2' => [
			'100' => [
...
FY1Q5iIv/aq2GzkiJw9V3g==',
		...
		'29' => [
			'100' => [
				'latest' => '29.0.15',
				'internalVersion' => '29.0.15.2',
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-29.0.15.zip',
				'web' => 'https://docs.nextcloud.com/server/29/admin_manual/maintenance/upgrade.html',
				'eol' => true,
				'minPHPVersion' => '8.0',
				'signature' => 'jDbWk7ZLdx1qAwlQWHd1O9sl5k9c/6n407zslZ/YoUc2ppp/wdzUGZUk82gdYVzQ
...
vbaIJ8CiZnKdMBDAdXAVMA==',
	...
	'beta' => [
		'31' => [
			'100' => [
				'latest' => '31.0.4 RC1',
				'internalVersion' => '31.0.4.0',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-31.0.4rc1.zip',
				'web' => 'https://docs.nextcloud.com/server/31/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.1',
				'signature' => '',
			],
		],
		'30.0.10.0' => [
			'100' => [
...
wclyLutrUJPB8B1oiKFUNw==',
		...
		'30' => [
			'100' => [
				'latest' => '30.0.10 RC1',
				'internalVersion' => '30.0.10.0',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-30.0.10rc1.zip',
				'web' => 'https://docs.nextcloud.com/server/30/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.1',
				'signature' => '',
			],
		],
		'29.0.16.0' => [
			'100' => [
...
Zp3g5oWLhkAWK2rE6UJmgg==',
		...
		'29' => [
			'100' => [
				'latest' => '29.0.16 RC1',
				'internalVersion' => '29.0.16.0',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-29.0.16rc1.zip',
				'web' => 'https://docs.nextcloud.com/server/29/admin_manual/maintenance/upgrade.html',
				'eol' => true,
				'minPHPVersion' => '8.0',
				'signature' => '',
			],
		],
		'28.0.14.1' => [
			'100' => [
