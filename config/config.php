	...
	'stable' => [
		'29' => [
			'100' => [
				...
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-29.0.2.zip',
...
oNTSD0aFMf+2zYzpI5wy3A==',
		...
		'28' => [
			'100' => [
				...
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-28.0.6.zip',
...
vbaIJ8CiZnKdMBDAdXAVMA==',
	...
	'beta' => [
		'29' => [
			'100' => [
				'latest' => '29.0.3 RC2',
				'internalVersion' => '29.0.3.1',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-29.0.3rc2.zip',
				'web' => 'https://docs.nextcloud.com/server/29/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.0',
				'signature' => '',
			],
		],
		'28.0.7.1' => [
			'100' => [
...
bwZLxwvB/VhCZKcYxq/xAA==',
		...
		'28' => [
			'100' => [
				'latest' => '28.0.7 RC2',
				'internalVersion' => '28.0.7.1',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-28.0.7rc2.zip',
				'web' => 'https://docs.nextcloud.com/server/28/admin_manual/maintenance/upgrade.html',
				'eol' => false,
				'minPHPVersion' => '8.0',
				'signature' => '',
			],
		],
		'27.1.11.1' => [
			'100' => [
...
Djv4QXNyyaF55M5OWV2dTg==',
		...
		'27' => [
			'100' => [
				'latest' => '27.1.11 RC2',
				'internalVersion' => '27.1.11.1',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-27.1.11rc2.zip',
				'web' => 'https://docs.nextcloud.com/server/27/admin_manual/maintenance/upgrade.html',
				'eol' => true,
				'minPHPVersion' => '8.0',
				'signature' => '',
			],
		],
		'26.0.13.1' => [
			'100' => [
