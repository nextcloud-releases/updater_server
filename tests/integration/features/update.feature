Feature: Testing the update scenario of releases
  ...
  Scenario: Updating an up-to-date non-staged Nextcloud 10.0.3 with PHP 5.4 on the production channel
    Given There is a release with channel "production"
    And The received PHP version is "5.4.0"
  ...
  Scenario: Updating an up-to-date non-staged Nextcloud 10.0.3 with PHP 5.4 on the stable channel
    Given There is a release with channel "stable"
    And The received PHP version is "5.4.0"
    And the installation mtime is "61"
    And The received version is "9.1.3.2"
  ...
  Scenario: Updating an outdated Nextcloud 10.0.0 on the beta channel with PHP 5.6
    ...
    When The request is sent
    Then The response is non-empty
    And Update to version "11.0.2.0" is available
    And URL to download is "https://download.nextcloud.com/server/prereleases/nextcloud-11.0.2RC1.zip"
    And URL to documentation is "https://docs.nextcloud.com/server/11/admin_manual/maintenance/upgrade.html"
  ...
  Scenario: Updating an up-to-date Nextcloud 11.0.2 on the beta channel
    Given There is a release with channel "beta"
    And The received version is "11.0.2.0"
    And The received PHP version is "5.6.0"
    When The request is sent
    Then The response is empty
