Feature: Testing the update scenario of stable releases
 ...
 Scenario: Updating an outdated Nextcloud 15.0.0 beta on the stable channel
  ...
  Scenario: Updating the Nextcloud 20.0.14 on the stable channel
    ...
    And URL to download is "https://download.nextcloud.com/server/prereleases/nextcloud-21.0.9.zip"
  ...
  Scenario: Updating the Nextcloud latest 21 to 22.2.5 on the stable channel
    Given There is a release with channel "stable"
  ...
  Scenario:  Updating the Nextcloud latest 22 to 23.0.2 on the stable channel
    Given There is a release with channel "stable"
  ...
  Scenario:  Updating the Nextcloud 23 to latest 23.0.2 on the stable channel
    Given There is a release with channel "stable"
